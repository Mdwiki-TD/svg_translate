...
class TestUploadTask:
    ...
    def test_upload_task_success(
        ...
        mock_mark_token_used.assert_called_once_with(42)
    ...
    def test_upload_task_oauth_failure(
        ...
        result, updated_stages = upload_task(
            ...
            "Main.svg",
            do_upload=True,
            user={"id": 7, "access_token_enc": b"token", "access_secret_enc": b"secret"},
        )
    ...
    def test_upload_task_updates_message(
        ...
        result, updated_stages = upload_task(
            ...
            "Main.svg",
            do_upload=True,
            user={"id": 24, "access_token_enc": b"token", "access_secret_enc": b"secret"},
        )

        assert result["not_done"] == 1
        assert updated_stages["status"] == "Failed"
        assert "Files uploaded" in updated_stages["message"]
        mock_mark_token_used.assert_called_once_with(24)
